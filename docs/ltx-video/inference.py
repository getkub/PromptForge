...
# Add the LTX-Video directory to Python path
import sys
sys.path.append('../Lightricks/LTX-Video')

from ltxv.pipeline import LTXConditionPipeline
...
def main():
    ...
    # Set up paths
    model_path = "../../ai_models/ltxv/ltxv-13b-0.9.7-distilled"
    
    # Initialize pipeline with custom model path
    ...
    safe_prompt = "".join(c if c.isalnum() else "_" for c in args.prompt)
    output_path = output_dir / f"{safe_prompt[:50]}.mp4"
